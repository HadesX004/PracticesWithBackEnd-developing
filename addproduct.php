...
<body onload="loadForm()">
    ...
    <form class="formItem" action="backend/add_product.php" method="POST">
        <!-- Navbar with title and buttons-->
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <a href="index.php"><h1 class="title">Product List</h1></a>

            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <button type="submit" class="btn btn-success align-left-button-add">Add</button>
